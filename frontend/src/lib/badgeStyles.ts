import type { Priority, ProjectStatus, TaskStatus, TicketStatus, TicketType } from '../types';
...
export const MILESTONE_STATUS_COLOR: Record<'upcoming' | 'overdue' | 'completed', string> = {
